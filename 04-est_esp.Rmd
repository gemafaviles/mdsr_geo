...
georreferenciadas cercanas están relacionadas (son **dependientes**) de 
alguna manera [@getis_1999], y por ello, trata de reconocer y aprovechar ésta 
ubicación espacial a la hora de diseñar, recopilar, gestionar, 
analizar y mostrar las observaciones (@montero_et_al_2011). 
...
de disciplinas científicas. Por ejemplo, @montero_et_al_2011 
...
1.  **Datos geoestadísticos: **Surgen cuando el dominio de estudio es **continuo
    ...
    La Fig. \@ref(fig:ejem_geo) presenta un mapa de interpolación krigeado del
...
<!-- # ```{r ejem_geo, echo=FALSE, fig.align='center', fig.cap='Mapa de interpolación del nivel de CO en el aire en la ciudad de Madrid'} -->
<!-- #  -->
