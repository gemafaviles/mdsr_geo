...
## Antes de continuar... \index{dependencia espacial}
...
De forma natural y de acuerdo a la \index{Ley Tobler} [@tobler1970] surge la idea de que
...
Los **datos espaciales**, también conocidos como datos **\index{geoespaciales}**, son
...
1.  **\index{Datos geoestadísticos}:** Surgen cuando el dominio de estudio es **continuo
...
2.  **\index{Datos reticulares}**: Surgen cuando: (i) el dominio bajo estudio $D$ es
...
3.  **\index{Procesos de puntos}:** Mientras que en los datos geoestadísticos y
