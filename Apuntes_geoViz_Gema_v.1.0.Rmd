...
Aquí lo primero es ver la dependencia, si no la estadística espacial se trata como estadística clásica.



Existen varias maneras de clasificar los datos espaciales. @cressie1993 propone la siguiente clasificación:
...
[**Los formatos**]{style="color:red"} más comunes de datos espaciales son vectores y ráster.
