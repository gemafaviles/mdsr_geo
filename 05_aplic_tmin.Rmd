...
abriendo el programa y creando un nuevo script de R en *File>New File>R script*.
...
[**Está explicado en la sección de CRS, es el código del CRS que usan los GPS,
el habitual para coordenadas longitud/latitud**]{style="color:blue"}
...
Como se comentó en la sección correspondiente, cuando se emplean datos
...
**Q3. Mis datos y el contorno de España están en el mismo CRS, pero ¿es el
adecuado?**

[**DIEGO, POR QUÉ TRANFSORMAMOS, PARA PASAR A UTM E INTERPRETAR EN
METROS?**]{style="color:red"}

[**Explicado más adelante, para hacer el grid en metros cuadrados. Si no, se
haría en grados cuadrados (¿?) porque long/lat no es medida de
superficie**]{style="color:blue"}
...
A continuación, para realizar la interpolación, necesitamos generar una malla
...
[**DIEGO, se útiliza mucho en espacial pero no se si este caso es muy
ilustrativo....r**]{style="color:red"}

[**Por mi lo quitamos**]{style="color:blue"}
