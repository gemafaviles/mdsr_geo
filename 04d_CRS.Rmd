...
Por este motivo, al representar ambos puntos en un mapa,
se observa que no se están refiriendo a la misma localización
...
cónica y acimutal o planar), dependiendo del tipo de superficie que se use para proyectar.
...
necesario que todos presenten el mismo CRS. En la Fig \@ref(fig:puertos-err) se
muestra lo que ocurre si esto no se cumple:
