...
```{r datos_desalineados, echo=FALSE}
...
plot(toledo_ok, add = TRUE, bg = "green", color = "black", pch = 21, cex = 2)

# Aún necesito transformarlo para crear el plot
plot(st_transform(toledo_err, st_crs(4326)),
...
```{r meridianos, echo=FALSE, fig.show="hold", out.width="50%"}
...
```{r mercator, echo=FALSE, out.width="40%"}
...
-   **Proyecciones cónicas**: En este tipo de proyecciones, se plantea la
    ...
    **proyección cónica equiáreas de Albers** es una de las proyecciones que más
    ...
    ```{r albers, echo=FALSE, out.width="40%"}
...
-   **Proyecciones acimutales o planares:** En este tipo de proyección se
    ...
    ```{r orto, echo=FALSE, out.width="40%"}
...
-   **Proyecciones conformales:** Estas proyecciones intentan preservar los
    ...
    ```{r conform, echo=FALSE, out.width="30%"}
...
-   **Proyecciones equivalentes**: Estas proyecciones preservan las proporciones
    ...
    ```{r equiv, echo=FALSE, out.width="30%"}
...
```{r equidist, echo=FALSE, out.width="30%"}
...
```{r comp, echo=FALSE, out.width="30%"}
...
adicionalmente en **R** existe el paquete `crsuggest` (DHH AÑADIR REFERENCIA)
que nos facilita la labor, sugiriendo el CRS más adecuado para cada zona:
