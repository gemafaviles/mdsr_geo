...
**¿Qué hace un \index{Sistemas de información geográfico}?**
...
Pero es más, el desarrollo de la \index{**Inteligencia Artificial**} y la **Inteligencia
...
**¿Y que es la \index{Geocomputación}?**
...
**¿Por que \index{R} para datos geográficos?**
...
-   **raster** [@R-raster], **terra** [@R-terra]y **stars** [@R-stars]para datos
    raster.
