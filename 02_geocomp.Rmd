...
La Fig. \@ref(fig:gisflujo) muestra el flujo de trabajo de los SIG, que va desde (i) la elaboración de mapas, (ii) la
...
computacional** se han convertido en herramientas creativas y
...
La geocomputación está muy relacionada con otros términos como los SIG, ya definidos, y con
...
visualización. Por ejemplo, los nuevos entornos de desarrollo integrado 
...
Madrid y, además, dejar la el código R para hacerlo reproducible, ver Fig.
\@ref(fig:leaflet).
...
-   `spdep` para el análisis de datos con modelos de econometría espacial, creación de
    matrices de contiguidad/distancia **W**, estimación de modelos econométricos
    espaciales, etc

-   `spatstat` para el análisis de procesos de puntos espaciales, inensidad, etc.
