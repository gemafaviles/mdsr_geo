...
-   Para cada valor de la columna `Unidad`, dividiremos el texto usando los
    espacios como delimitadores (`"45115 Noblejas"` pasará a ser
    `c("45115", "Noblejas")`) y extraeremos el código como el primer valor del
    vector (`c("45115", "Noblejas")[1]` extrae el primer valor del vector, es
    decir, `"45115"`).
...
paquete **readr** [@R-readr] para importar los datos:
...
podemos extraer del paquete **mapSpain**.
...
Analice la existencia de patrones espaciales en los delitos registrados en el
año 2010.
:::
