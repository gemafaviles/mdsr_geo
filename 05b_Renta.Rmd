...
1.  Fichero `renta_municipio.csv`: Este fichero contiene información de la Renta
    Neta per cápita por municipios (en euros), distritos y secciones censales. Esta
...
**Tatea 2. Comprobamos campos en común para un municipio: Noblejas**
...
** Tarea 4: Unimos los objetos renta y mapas con la función `left_join`**
...
** Q5. ¿Qué ocurre si realizáramos el proceso poniendo los datos espaciales en el lado
derecho del join?**


A modo de ejemplo, si realizáramos el proceso poniendo los datos espaciales en el lado
...
**Tarea 6. Histograma de la distribución de la renta**
...
**Tarea 7. Mapa de coropletas de la distribución de la renta**
...
**Tarea 7. Eliminamos los municipios sin datos y cambiamos la escala de color**
...
**Tarea 8. Agrupar los datos en clases para mejorar la visualización**
...
-   El método de intervalos equivalentes: divide el rango de valores
...
**Tarea 9. Representar los mapas según las clases obtenidas**
...
El mapa de la Fig. \@ref(fig:mapa_deciles) ya nos permite observar patrones geográficos, donde se ve una clara
...
El mapa de la Fig. \@ref(fig:mapa_fisher), sin embargo, se parece más al mapa que hicimos con los datos sin
...
En el mapa de la Fig. \@ref(fig:trucado) se puede observar de una manera más clara un cluster adicional de
...
** Q.10 Tenemos un mapa de los mismos datos pero la información se
