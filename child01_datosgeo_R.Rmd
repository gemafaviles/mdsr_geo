...
En el ámbito del análisis espacial en **R**, se pueden clasificar los **datos** o **el formato?, pregunto sólo**
espaciales en función del modelo de datos [@Lovelance_et_al_2019]. Se pueden 
distinguir dos tipos de modelos de datos:
