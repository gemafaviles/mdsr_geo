...
\addcontentsline{toc}{section}{Sobre este libro}
...
{\centering \includegraphics[width=0.6\linewidth]{Visualización_geolocalización_datos_files/figure-latex/unnamed-chunk-13-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{Visualización_geolocalización_datos_files/figure-latex/unnamed-chunk-15-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{Visualización_geolocalización_datos_files/figure-latex/unnamed-chunk-20-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{Visualización_geolocalización_datos_files/figure-latex/unnamed-chunk-21-1} 

}

\caption{Temperatura mínima interpolada. 8 de Enero 2021. }\label{fig:unnamed-chunk-21}
\end{figure}
...
En el caso de Noblejas, el código completo es \textbf{45115}. Sin embargo, en el caso
de la tabla \texttt{renta}, debemos extraer ese valor del literal, ya que no tenemos
este valor directamente, sino en combinación con otros valores (``\textbf{45115
Noblejas}''). Para conseguir extraer un campo adecuado para el cruce en la tabla
\texttt{renta} que contenga únicamente el código numérico vamos a hacer la siguiente
...
\NormalTok{valencia }\OtherTok{\textless{}{-}} \FunctionTok{esp\_get\_munic}\NormalTok{(}\AttributeTok{munic =} \StringTok{"\^{}Valencia$"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \CommentTok{\# Necesitamos proyectar, en este caso usamos ETRS89{-}UTM huso 30 EPSG:25830}
...
{\centering \includegraphics[width=0.6\linewidth]{Visualización_geolocalización_datos_files/figure-latex/unnamed-chunk-28-1} 
